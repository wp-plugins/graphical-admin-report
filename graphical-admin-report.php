...
Thanks to fusion Charts team for this SWF graph. || <a target="_blank" href='http://gopi.coolpage.biz/demo/2009/08/22/graphical-admin-report/'>click here</a> to post suggestion or comments or How to improve this report plugin. || <a target="_blank" href='http://gopi.coolpage.biz/demo/2009/08/22/graphical-admin-report/'>click here</a> to see my plugin demo. || <a target="_blank" href='http://gopi.coolpage.biz/demo/2009/08/22/graphical-admin-report/'>click here</a> to download my other plugin. || 
Clicking below ad will not affect your graph or site or any!! To remove this ad simple remove "timepass()" this function from page.<br>
<br>
<?php
	timepass() ;
}
...
{
	add_options_page('Graphical Report', 'Graphical Report', 7, __FILE__, 'Greport_admin_options' );
}
